 ...
 * contents of a view via a vertical swipe gesture. The com.xhq.ui.activity that
 ...
 * indication of a refresh. If an com.xhq.ui.activity wishes to show just the progress
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_CANCEL: {
                ...
                mActivePointerId = INVALID_POINTER;
                mInitialMotionY = INVALID_POINTER;
                return false;
            }
        }
