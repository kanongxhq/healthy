...
/**
 * Created by kanongxhq on 15/8/30.
 */
    ...
    public static int[][] themeColorArr = {
        ...
        public static int getThemeColor() {
                return BaseApplication.getInstance().getResources().
                        getColor(themeColorArr[SettingUtility.getIntSetting(SettingUtility.APP_THEME)][0]);
        }

        public static int getThemeColor(Context context){
                final int materialBlue = Color.parseColor("#ff0000");
                int themeColor = materialBlue;
                TypedArray a = context.getTheme().obtainStyledAttributes(new int[]{R.attr.theme_color});
                try {
                        themeColor =  a.getColor(0, materialBlue);
                } finally {
                        a.recycle();
                }
                return themeColor;
