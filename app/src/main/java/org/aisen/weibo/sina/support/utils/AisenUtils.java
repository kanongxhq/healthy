...
//            window.setStatusBarColor(Utils.resolveColor(com.xhq.ui.activity, R.attr.theme_statusbar_color, Color.BLUE));
...
//            window.setNavigationBarColor(Utils.resolveColor(com.xhq.ui.activity, R.attr.theme_color, Color.BLUE));

//            Window window = com.xhq.ui.activity.getWindow();
...
//            window.setNavigationBarColor(Utils.resolveColor(com.xhq.ui.activity, R.attr.theme_statusbar_color, Color.TRANSPARENT));
        }
    }

    public static void setPicStatusBar(Activity activity) {
//        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
//            com.xhq.ui.activity.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
//            Window window = com.xhq.ui.activity.getWindow();
//            window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS
//                    | WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
//            window.getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN
